...
import { ScheduleDay } from "@/components/blocks/tournament/schedule-day"
import { SoccerIcon, GamingAwardIcon } from "@/components/website-base/icons"
                    ...
                    <div>
                        <ScheduleDay
                            ...
                            sessions={[
                                ...
                                { title: "Championship Match", time: "4:30 - 5:30 PM", icon: GamingAwardIcon },
                            ]}
                        />
                    </div>
                </TabsContent>
