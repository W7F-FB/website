  ...
  return (
    <Card className={cn("overflow-hidden group rounded-none", className)}>
      ...
      <CardHeader>
        <div className="flex-col md:flex-row flex justify-between text-sm mb-2">
            {blog.category && (
              <Badge
                variant="secondary"
                className="text-[var(--color-accent-green)] rounded-none uppercase text-md"
              >
                {blog.category}
              </Badge>
            )}
      ...
      <CardContent>
        ...
        <Button variant="link" className="text-[var(--color-accent-green)] p-0 hover:underline text-xs font-light">
            Read more →
        </Button>
      </CardContent>
    </Card>
      ...
      <div className="flex flex-col justify-center w-full md:w-[60%] p-6">
        <div className="flex flex-col md:flex-row justify-start text-sm mb-2 gap-4">
          {blog.category && (
            <Badge
              variant="secondary"
              className="text-[var(--color-accent-green)] rounded-none uppercase text-sm"
            >
              {blog.category}
            </Badge>
          )}
        ...
        <Button
          variant="link"
          className="text-[var(--color-accent-green)] p-0 hover:underline text-xs font-light justify-start mt-2"
        >
          Read more →
        </Button>
      </div>
    ...
    <Card className={cn("flex flex-col md:flex-row overflow-hidden group rounded-none p-0", className)}>
      ...
      <div className="flex flex-col justify-between w-full md:w-1/2 p-6">
        ...
        <CardFooter className="p-0 mt-4">
          <Button
            variant="link"
            className="text-[var(--color-accent-green)] p-0 hover:underline text-xs font-light"
          >
            Read more →
          </Button>
        </CardFooter>
