        ...
        <div>
            <Container maxWidth="lg">
                ...
                <Section padding="md" className="text-center">
                    <H2 className="uppercase py-12 text-4xl">Rising Sevens Youth Tournament by W7F</H2>
                ...
                <Section padding="md">
                    <div className="grid grid-cols-2 gap-12">
                        <div>
                            <H3 className="uppercase mb-6">About Rising Sevens</H3>
                        ...
                        <div>
                            <H3 className="uppercase mb-6">Tournament Info</H3>
