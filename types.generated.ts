...
interface BlogDocumentData {
	 ...
	 */
	category: prismic.SelectField<"Announcements" | "Tournament Recap" | "Match Recap" | "Social Impact" | "Match Day Preview">;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ImageWithTextDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<ImageWithTextDocumentData>, "image_with_text", Lang>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type PolicyDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<PolicyDocumentData>, "policy", Lang>;
...
interface TeamMemberDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	department: prismic.SelectField<"Player Advisor" | "Co-Founder" | "Leadership Team">;
}
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type TournamentDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<TournamentDocumentData>, "tournament", Lang>;
...
export interface WebsiteDocumentDataFooterMenusItem {
	 ...
	 */
	menu_links: prismic.NestedGroupField<Simplify<WebsiteDocumentDataFooterMenusMenuLinksItem>>;
}
...
interface WebsiteDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
	 */
	footer_menus: prismic.GroupField<Simplify<WebsiteDocumentDataFooterMenusItem>>;
}
...
export type AllDocumentTypes = BlogDocument | ImageWithTextDocument | PolicyDocument | TeamMemberDocument | TournamentDocument | WebsiteDocument;
